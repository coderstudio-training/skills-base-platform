        ...
        <TabsContent value="overview">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Discover how our platform can transform your team's skills management</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="benefits">
          <Card>
            <CardHeader>
              ...
              <CardDescription>See the impact SkillBase can have on your organization</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>

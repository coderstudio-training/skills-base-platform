        ...
        <TabsContent value="overview">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{adminData.totalEmployees}</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Organization-wide performance over the last 6 months</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="performance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Employees with the highest performance scores</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {adminData.topPerformers.map((employee, index) => (
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span>Employees in Training Programs</span>
                  <span className="font-semibold">{adminData.employeesInTraining} ({(adminData.employeesInTraining /
 adminData.totalEmployees * 100).toFixed(2)}%)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Average Training Satisfaction</span>
                  <div className="flex items-center">
                    <span className="font-semibold mr-2">{adminData.averageTrainingSatisfaction.toFixed(1)}/5</span>
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Award key={star} className={`h-4 w-4 ${star <= Math.round(adminData.averageTrainingSatisfaction) ? 'text-yellow-400' : 'text-gray-300'}`} />
                      ))}
                    </div>
                  </div>
                </div>

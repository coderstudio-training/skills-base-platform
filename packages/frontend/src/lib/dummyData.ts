...
export const dummyStaffData: StaffData = {
    ...
    careerPaths: [
        { role: "Senior Software Engineer", requiredSkills: ["System Design", "Team Leadership"] },
        { role: "Technical Lead", requiredSkills: ["Project Management", "Architecture"] },
        { role: "Engineering Manager", requiredSkills: ["People Management", "Strategic Planning"] },
    ],
};

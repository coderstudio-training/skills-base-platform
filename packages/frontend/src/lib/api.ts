...
import { AdminData, Department, Staff, Skill, Course, LearningPath } from '@/types/admin';
...
export async function assignCourseToStaff(staffId: string, courseId: string): Promise<{ success: boolean; message: string }> {

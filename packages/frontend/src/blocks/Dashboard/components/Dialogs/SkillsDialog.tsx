import { ViewSkillsButton } from '@/blocks/Dashboard/components/Buttons/ViewSkillsButton';
import { SkillsDialogProps } from '@/blocks/Dashboard/types'; // Adjust the import path as needed
import {
  Dialog,
  DialogContent,
  DialogDescription,
